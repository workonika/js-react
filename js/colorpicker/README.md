...
Вы можете менять структуру виджета: добавлять дополнительные элементы-обёртки. Вы можете добавлять классы к имеющимся. Но нельзя перемещать элементы из одной главной области в другую. Нельзя переименовывать установленные классы. Тогда виджет не будет работать. Управление производится на основе классов!
